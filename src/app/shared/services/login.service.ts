...
export class LoginService {
  ...
  /* signup(mail:string, pass:string){
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAQwnUJj5oNIyrtQH575EMIXEo40c6iNiw',
     { email:mail , password: pass ,returnSecureToken:true}
     );
   } */

  login(mail: string, pass: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAQwnUJj5oNIyrtQH575EMIXEo40c6iNiw', { email: mail, password: pass, returnSecureToken: true }
    ).pipe(
